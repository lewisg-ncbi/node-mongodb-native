      ...
      new Db(object.dbName, __server, {w:1, native_parser:false}).open(function(err, db) {
        ...
        if(totalNumberOfServers == 0) {
          ...
          if(totalNumberOfMongodServers == 0
            ...
            // if replSet.auto exists and is false, don't automatically set up all servers
            // in the replica set
            if(totalNumberOfMongodServers > 0 && (typeof object.rs_options.auto == 'undefined' || object.rs_options.auto)) {
              try {
